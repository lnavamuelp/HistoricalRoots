...
package com.openuax.myhistoricalrootsapplication.interfaces
...
import com.openuax.myhistoricalrootsapplication.MainActivity
...
fun LoginFormPreviewDark() {
    MyHistoricalRootsApplicationTheme(darkTheme = true) {
        LoginForm()
    }
}